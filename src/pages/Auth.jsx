...
const Auth = ({ register }) => {
    ...
    return (
        <>
            <div className="container-fluid" style={{ backgroundImage: 'url(https://static.vecteezy.com/system/resources/thumbnails/036/596/544/small_2x/ai-generated-library-advertisment-background-with-copy-space-free-photo.jpg)', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', height: '100vh', width: '100%' }}>
                <div className="row">
                    <div className="col-md-3"></div>
                    <div className="col-md-6 d-flex flex-column align-items-center justify-content-center mt-5 ">
                        <h3 className='text-white'>BOOKBUZZ</h3>
                        <form className='form-control  d-flex flex-column justify-content-center align-items-center px-4' style={{ backgroundColor: 'rgba(0, 0, 47, 1)', border: 'transparent', marginTop: '10px' }}>
                            <div className='d-flex flex-column align-items-center mb-3 mt-3'>
                                ...
                                {!register ? <h4 className='mt-2 text-light'>Login</h4>
                                    :
                                    <h4 className='mt-2 text-light'>Register</h4>}
                            </div>
